...
function assignment_of_PV!(math::Dict, load_profiles::_DF.DataFrame, repitition::Int, S_inverters::Vector{Any}, voltvar_curve::Vector{Tuple{Float64, Real}}; Nr_PV_buildings::Int=18)
