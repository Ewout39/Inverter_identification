...
panel_area = 2.0 #m2
voltvar_curve = [(0.6, -0.44), (0.92, -0.44), (0.99, 0), (1.01, 0), (1.08, 0.44), (1.4, 0.44)] #TODO need to make varying still
varP_curve = [(0, 0), (0.2, 0.0), (0.95,  0.3)] #TODO need to make varying still
PF = 0.98 #TODO need to make varying still
repititions = 6 #TODO change this back to 6
Nr_pv_buildings = 18
Z_value = 1.7
...
for current_repitition in 6:repititions
...
visualize_voltvar_curve_single_load(Result_dict, voltvar_curve, repitition, "43")
